            ...
            <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 ">
              <Tab>
                <button
                  ...
                  className="font-medium border-b-2 hover:shadow-purple-700 border-purple-500 text-purple-500 rounded-lg text-xl shadow-[inset_0_0_8px_rgba(253,201,2,0.6)]  px-5 py-1.5 text-center bg-[#605d5d12] "
                >
              ...
              <div className="  px-4 md:px-0 mb-16">
                ...
                <div className=" flex justify-end">
                  <button
                    ...
                    style={{
                      backgroundColor: mode === "dark" ? "rgb(46 49 55)" : "#f8792a",
